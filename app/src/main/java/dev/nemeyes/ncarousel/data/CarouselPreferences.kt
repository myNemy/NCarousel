...
class CarouselPreferences(context: Context) {
    ...
    /**
     * When true, automatic wallpaper WorkManager jobs require an unmetered network (typically Wi‑Fi).
     * Manual apply / Library still work on any connection.
     */
    var autoWallpaperUnmeteredOnly: Boolean
